...
def catmull_rom(points: list[Vector], points_per_segment: int) -> list[Vector]:
    ...
    curve.extend(interpolate([points[-1], points[0], points[1], points[2]], points_per_segment))
    ...
    curve.extend(interpolate([points[N-3], points[N-2], points[N-1], points[0]], points_per_segment))

    # Last segment has second point as P3
    curve.extend(interpolate([points[N-2], points[N-1], points[0], points[1]], points_per_segment))
